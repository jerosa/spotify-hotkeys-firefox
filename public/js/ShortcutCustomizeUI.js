...
const ShortcutCustomizeUI = {
    ...
    get commonClass() {
        ...
        this.commonClass = `shortcut-customize-ui-${this.uniqueKey}`;
    ...
    async build(options) {
        ...
        for (let command of commands) {
            ...
            const checkboxes = isMac ? [metaLabel, ctrlLabel, altLabel, shiftLabel] : [ctrlLabel, altLabel, shiftLabel];

            const createEvent = (aName, aShortcut) => new CustomEvent("ShortcutChanged", {
                detail: {
                    name: aName,
                    key: aShortcut
                }
    ...
    normalizeKey(aKey) { // eslint-disable-line complexity
